...
import ec.edu.ups.controladores.ControladorArtropodo;
import ec.edu.ups.controladores.ControladorAve;
import ec.edu.ups.controladores.ControladorMetazoo;
                ...
                do {
                    ...
                    switch (op2) {
                        ...
                        case 3:
                            ...
                            Pez objetoNuevo = new Pez(agua, aleta, mandibula, camuflaje, numeroHuesos, vertebrado[0], vertebrado[1], vertebrado[2], animal2[0], animal1[0], animal2[1], animal2[2], animal1[1]);
                ...
                do {
                    ...
                    switch (op3) {
                        case 1:
                            ...
                            Ave objeto = new Ave(numeroAlas, volador, formaPico, campoVison, numeroHuesos, vertebrado[0], vertebrado[1], vertebrado[2], animal2[0], animal1[0], animal2[1], animal2[2], animal1[1]);
                        ...
                        case 3:
                            ...
                            Ave objetoNuevo = new Ave(numeroAlas, volador, formaPico, campoVison, numeroHuesos, vertebrado[0], vertebrado[1], vertebrado[2], animal2[0], animal1[0], animal2[1], animal2[2], animal1[1]);
                ...
                do {
                    ...
                    switch (op4) {
                        case 1:
                            ...
                            Artropodo objeto = new Artropodo(forma, apendice, cabeza, poro, invertebrado[0], invertebrado[1], invertebrado[2], invertebrado[3], animal2[0], animal1[0], animal2[1], animal2[2], animal1[1]);
                        ...
                        case 3:
                            ...
                            System.out.println("** Ingrese los poros(true/false)");
                            poro = sc.nextBoolean();
                            Artropodo objetoNuevo = new Artropodo(forma, apendice, cabeza, poro, invertebrado[0], invertebrado[1], invertebrado[2], invertebrado[3], animal2[0], animal1[0], animal2[1], animal2[2], animal1[1]);
                ...
                do {
                    ...
                    switch (op5) {
                        ...
                        case 3:
                            ...
                            System.out.println("** Ingrese la piel");
                            piel = sc.next();
                            Metazoo objetoNuevo = new Metazoo(cuerpoBlando, simetria, piel, antenas, invertebrado[0], invertebrado[1], invertebrado[2], invertebrado[3], animal2[0], animal1[0], animal2[1], animal2[2], animal1[1]);
                        ...
                        case 4:
                            ...
                            System.out.println("** Ingrese el codigo");
                            codigo = sc.nextInt();
                            controladorMetazoo.delete(controladorMetazoo.read(codigo));
                            break;
                    }
                } while (op5 != 5);
            }
